...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] NGENTOT SAJAH DEK | Api Connected [5] | Backup Server [1] | Online User [2] | Admin: [ 𝙲𝙴𝙽†𝚃𝚁𝙰𝙻 ] | POWER : {}% [UNSTABLE]\x07".format (powerran))
